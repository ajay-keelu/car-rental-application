...
const Register = () => {
  ...
  const passwordIconChange = () => {
    ...
    if(document.getElementById('password-reg').type == 'text')
        ...
        document.getElementById('password-reg').type = 'text'
  }
  const signUp = () =>{
        ...
        <div className='signup'>
          <h3 className='signText'>Register Here</h3>
            <div className='signup-input'>
                ...
                <div className='signup-div'>
                  <input type='password' id='password-reg' placeholder='PASSWORD' name='password' onChange={updateValue} className='cont-spac' />
